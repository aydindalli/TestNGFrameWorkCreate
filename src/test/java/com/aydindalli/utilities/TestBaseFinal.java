package com.aydindalli.utilities;
...
public abstract class TestBaseFinal {
    ...
    public void setUpTest() {//This is how to set up Extent report. We will create and use this one in out test classes
        ...
        String filePath = System.getProperty("user.dir") + "/test-output/projeRaporlarim.html";//create a custom report in the current project.
        ...
        extentReports.setSystemInfo("Automation Engineer", "Dalli Aydin");
        extentHtmlReporter.config().setDocumentTitle("Amazon Reports");
        extentHtmlReporter.config().setReportName("Amazon Automation Reports");
    }
